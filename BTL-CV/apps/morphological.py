...
def app():
    demo_image = 'imgTests/erosion1.jpg'
    selected_box = st.sidebar.selectbox('Choose one of the operations', ('None', 'Erosion', 'Dilation', 'Opening', 'Closing'))
    ...
    if selected_box == 'None':
        ...
        st.markdown(
            '<ul> <li> Erosion <li> Dilation <li> Opening <li> Closing </ul>',
